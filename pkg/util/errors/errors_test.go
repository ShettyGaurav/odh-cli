...
func TestClassify(t *testing.T) {
	...
	t.Run("should classify ExitCodeError with ExitError and prohibited message as LINT_BLOCKED", func(t *testing.T) {
		g := NewWithT(t)
		err := clierrors.NewExitCodeError(clierrors.ExitError, errors.New("prohibited or blocking findings detected"))
		result := clierrors.Classify(err)
